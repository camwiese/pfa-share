...
function ppie({ idx, base, text, alt, dims }) {
  return `<section class="panel panel--cream panel--ppie" data-panel="${idx}">
    <div class="ppie__content">
      <p class="ppie__text" data-animate="1">${text}</p>
      <figure class="ppie__figure" data-animate="2">${img({ base, alt, dims, sizes: "(max-width: 860px) 92vw, 1000px", className: "ppie__image" })}</figure>
    </div>
  </section>`;
}
...
const PANELS_HTML = [
  ...
  // 2
  ppie({ idx: 2, base: "1915-PPIE-full", text: "In 1915, the Panama-Pacific International Exposition welcomed 19 million people to San Francisco. They walked through the greatest achievements of their time, and left believing anything was possible.", alt: "The Panama-Pacific International Exposition, San Francisco, 1915", dims: { w: 3393, h: 1352 } }),
  // 3
  ppie({ idx: 3, base: "palace-only", text: "The last building standing from that fair is the Palace of Fine Arts.", alt: "The Palace of Fine Arts today", dims: { w: 2048, h: 816 } }),
  // 4
  ...
  `<section class="panel panel--cream panel--welcome" data-panel="5">
    <div class="welcome__content">
      ...
      <p class="welcome__sub" data-animate="2">Our vision for San Francisco&rsquo;s new home of progress.</p>
      <p class="welcome__year" data-animate="3">Palace of Fine Arts &middot; 2030</p>
      <figure class="welcome__figure" data-animate="4">${img({ base: "Park-Lagoon-2", alt: "The Palace of Fine Arts and lagoon, reimagined", dims: { w: 1672, h: 941 }, sizes: "(max-width: 860px) 90vw, 760px", className: "welcome__image" })}</figure>
    </div>
  </section>`,
  // 6
  ...
  // 7
  prose({ idx: 7, text: "Modeled after the great pavilions of the 1915 Exposition, Tour into Tomorrow lets you walk through four visions of the future.", follow: "Each inspired by real breakthroughs happening across the Bay Area." }),
  // 8–11 — Tour exhibits
  ...
  // 12–15 — Future Lab
  prose({ idx: 12, text: "Future Lab is where inspiration becomes action. A hands-on STEM center where kids and adults alike can get involved in building the future." }),
  ...
  prose({ idx: 16, text: "At the heart of it all, a beautiful space celebrating the history of the Exposition, with dining experiences showcasing the Bay Area’s global culinary culture and the future of food." }),
  imagePanel({ idx: 17, base: "fare-6", alt: "World’s Fare food hall", dims: { w: 1672, h: 941 } }),
  imagePanel({ idx: 18, base: "fare-1", alt: "Mezzanine dining at the Palace", dims: { w: 1681, h: 936 } }),
  imagePanel({ idx: 19, base: "fare-3", alt: "Dining experience at the Palace", dims: { w: 1672, h: 941 } }),
  // 20–24 — Grounds
  prose({ idx: 20, text: "Every detail considered to create the most beautiful public space in the country. Open to all, from morning to night." }),
  ...
  `<section class="panel panel--cream panel--impact" data-panel="25">
    <div class="impact__content">
      <p class="impact__text" data-animate="1">Every visit leaves you with a sense of wonder&nbsp;&mdash; and a reason to come back.</p>
    </div>
  </section>`,
  // 26 — Call
  `<section class="panel panel--cream panel--call" data-panel="26">
    <div class="call__content">
      <p class="call__text" data-animate="1">If you&rsquo;re reading this, we&rsquo;d love your help bringing it to life.</p>
    </div>
  </section>`,
  // 27 — Letter
  `<section class="panel panel--cream panel--letter" data-panel="27">
    <div class="letter__content">
      ...
      <div class="letter__sign" data-animate="2">
        ...
        <p class="letter__title">CEO, The World&rsquo;s Fair Company</p>
