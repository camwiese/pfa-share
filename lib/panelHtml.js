...
const PANELS_HTML = [
  ...
  sectionIntro({
    idx: 7,
    text: `Modeled after the great pavilions of the 1915 Exposition,<br><span class="section-intro__name">Tour&nbsp;into&nbsp;Tomorrow</span> lets you explore four visions of the future.`,
    base: "map-exhibit",
  ...
  imagePanel({ idx: 17, base: "fare-1", alt: "The Grand Hall, looking out from the mezzanine", dims: { w: 1672, h: 941 } }),
  ...
  sectionIntro({
    idx: 20,
    text: `The <span class="section-intro__name">Grounds</span> are reimagined as the most beautiful public space in the country, open to all, from morning to night.`,
    base: "map-grounds",
